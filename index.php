...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="styles/simpshots.css">
        ...
        <main>
            ...
            <footer class="marquee" class="marquee--footer">
                <div class="marquee--footer__content">
                    <div class="marqueeFirst">Created by <a href="https://twitter.com/__mookid" target="_blank">mookid</a></div>                    
                    <div class="marqueeSecond">Created by <a href="https://twitter.com/__mookid" target="_blank">mookid</a></div>                    
                </div>
            </footer>
        </main>    
